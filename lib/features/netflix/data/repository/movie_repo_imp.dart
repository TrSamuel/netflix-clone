import 'package:netflixclone/features/netflix/data/source/remote/movie_api_service.dart';
...
class MovieRepoImp extends MovieRepo {
  ...
  @override
  Future<List<Movie>> searchMovies(String query) async => await movieSource.searchMovies(query);
}
